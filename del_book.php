...
<body alink="none" vlink="none">
	...
	<table align="right" class="home"><tr><td><a href="index.html"><img src="Graphicloads-100-Flat-Home.ico" width="20px" height="20px"></a></td>
		...
		<table cellspacing="3px" cellpadding="5px" rules="cols">
			<form method="post">
			<tr>
			<td><font face="Times new roman" size="7px" color="white"><center><b>DELETE BOOK<hr></b></td>
			</tr>
			<tr>
			<td><center>
				<font face="Times new roman" size="5px" color="grey">Enter ISBN No. :<br>
			...
			<tr>
				<td><center>
					<font face="Times new roman" size="5px" color="grey">Enter Book Name : <br>
		...
		{	
			...
			if($num == 1)
			{
				$sql="delete from book where isbn='$isbn' || name='$name'";
