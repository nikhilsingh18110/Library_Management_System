...
<body alink="none" vlink="none">
	...
	<table align="right" class="home"><tr><td><a href="index.html"><img src="Graphicloads-100-Flat-Home.ico" width="20px" height="20px"></a></td>
		...
		<table cellspacing="3px" cellpadding="5px" rules="cols">
			<form method="post">
			<tr>
			<td ><font face="Times new roman" size="5px" color="grey"><center><b>STUDENT LOGIN<hr width="80%"></b>
			</tr>
			
			<tr>
			<td><font face="Times new roman" size="4px" color="white">Roll Number : <br>
		...
		<?php
			...
			if(isset($_POST['submit1']))
			{
				...
				$s="select rollno, password from student where rollno='$rollno' and password='$password'";
				...
				{
					echo"Worng Roll Number OR Password";
		...
		<center><a href="login.php"><font face="times new roman" size="5px" color="blue"><b>Admin Login</a></b></font>
		<br>
		<hr width="15%">
		<br>
		
		<center><font face="times new roman" size="5px" color="red"><b>New to Library </b></font>
