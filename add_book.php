...
<body alink="none" vlink="none">
	...
	<table align="right" class="home"><tr><td><a href="index.html"><img src="Graphicloads-100-Flat-Home.ico" width="20px" height="20px"></a></td>
		...
		<table cellspacing="3px" cellpadding="5px" rules="cols">
			<form method="post">
			<tr>
			<td><font face="Times new roman" size="7px" color="white"><center><b>ADD NEW BOOK<hr></b></td>
			</tr>
			<tr>
			<td><center>
			...
			<tr>
				<td><center>
					<div class="btn">
					<br>
					<center><input type="submit" name="submit2" value="ADD"></center>
				</td>
			</tr>
			<tr>
			<td>
		...
		{	
			...
			$s="select * from book where isbn='$isbn'";
			...
			{
				$sql="insert into book(isbn, name, category, authour, total, availiable) values ('$isbn', '$name', '$category', '$authour', '$total', '$availiable')";
