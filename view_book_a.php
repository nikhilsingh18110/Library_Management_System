...
<body alink="none" vlink="none">
	...
	<tr>
	<td bgcolor="#214B8C"><center><a href="add_book.php"><font face="times new roman" size="5px" color="white">ADD BOOK</a>
	<td bgcolor="#214B8C"><center><a href="edit_book.php"><font face="times new roman" size="5px" color="white">EDIT BOOK</a>
	<td bgcolor="#214B8C"><center><a href="del_book.php"><font face="times new roman" size="5px" color="white">DELETE BOOK</a>
	</tr>
	</table>
	</center>	
	</div>
