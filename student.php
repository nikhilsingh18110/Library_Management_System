...
<body alink="none" vlink="none">
	...
	<br>
	<center><font face="times new roman" size="7.5px" color="#214B8C">WELCOME &nbsp;<?php echo $_SESSION['rollno'];?></font></center>
	...
	<table align="right" class="home"><tr><td><a href="index.html"><img src="Graphicloads-100-Flat-Home.ico" width="20px" height="20px"></a></td>
		...
		<tr>
		<td bgcolor="#214B8C"><center><a href="personal.php"><font face="times new roman" size="5px" color="white">PERSONAL DETAILS</a>
		</tr>
		<tr>
		<td bgcolor="#214B8C"><center><a href="view_book_s.php"><font face="times new roman" size="5px" color="white">VIEW BOOKS</a>
		</tr>
		<tr>
		<td bgcolor="#214B8C"><center><a href="index.html"><font face="times new roman" size="5px" color="white">LOGOUT</a>
		</tr>
		</table>
		</center>
		</div>
